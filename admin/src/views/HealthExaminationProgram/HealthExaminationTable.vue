...
<el-card class="box-card">
    <div slot="header" class="clearfix">
        ...
        <el-button style="float: right; padding: 3px 0" type="text">返回上一页 </el-button>
    </div>
    <div class="template">
        <el-button size="mini" style="margin-left:16px;" @click.prevent="add">新增</el-button>
        <el-button size="mini" type="primary" plain="" @click.stop='handleDownload'>下载模板</el-button>
    ...
    methods: {
        ...
        async del(row){
            ...
            this.$confirm(`确定移除?`, '提示', {
                ...
                await this.$http.post('/deleteCheckInfo',{_id:row._id})
                this.$message({
                    type: 'success',
                    message: '删除成功!'
                });
